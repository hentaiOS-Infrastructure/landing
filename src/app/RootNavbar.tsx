...
const RootNavbar = () => {
  ...
  return (
    <nav
      className={clsx(
        "fixed top-0 left-0 right-0 flex flex-row justify-center overflow-visible border-b border-transparent bg-neutral-50/70 backdrop-blur transition-[max-height] duration-500",
